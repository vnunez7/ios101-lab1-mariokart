...
class ViewController: UIViewController,
  ...
  @IBAction func didDoubleTapKart(_ sender: UITapGestureRecognizer) {
    ...
    // YOUR CODE HERE
      ...
      }) // note: you have to comment out the above translate function for this to work
  }
  ...
  override func viewDidAppear(_ animated: Bool) {
    super.viewDidAppear(animated)
      runStartingAnimationsAllAtOnce() // part of step 7
      runStartingAnimationsOneByOne() // part of step 8
      runStartingAnimationsOneByOne { // part of step 9
          self.raceKartsWithSameSpeed()
        }
      
      runStartingAnimationsOneByOne { // part of step 10
